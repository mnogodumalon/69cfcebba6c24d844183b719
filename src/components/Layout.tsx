...
import { IconAlertCircle, IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconPackage } from '@tabler/icons-react';
...
const APP_TITLE = 'TrueCost Manager';
...
const navigation = [
  ...
  { name: 'Produktverwaltung', href: '/produktverwaltung', icon: IconPackage },
  { name: 'Ersatzteilpreise', href: '/ersatzteilpreise', icon: IconFileText },
  { name: 'Reparatur & Wartung', href: '/reparatur-&-wartung', icon: IconFileText },
  { name: 'Wiederverkaufswert', href: '/wiederverkaufswert', icon: IconFileText },
  { name: 'TCO-Bewertung', href: '/tco-bewertung', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Produktverwaltung', href: '/gateway/apps/69cfce9261b99eaf5d9c387c?template=list_page', icon: IconPackage },
  { name: 'Ersatzteilpreise', href: '/gateway/apps/69cfce988e516fa818e648dd?template=list_page', icon: IconFileText },
  { name: 'Reparatur & Wartung', href: '/gateway/apps/69cfce98377270b96297983d?template=list_page', icon: IconFileText },
  { name: 'Wiederverkaufswert', href: '/gateway/apps/69cfce99712efab823a74844?template=list_page', icon: IconFileText },
  { name: 'TCO-Bewertung', href: '/gateway/apps/69cfce9a01bb987b5721b7f0?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69cfce9261b99eaf5d9c387c?template=list_page"
